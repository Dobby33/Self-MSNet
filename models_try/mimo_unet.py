...
class MIMOUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        z2 = self.SCM2(x_2)
        z4 = self.SCM1(x_4)
        print(x.shape, x_2.shape, x_4.shape, z2.shape, z4.shape)
        outputs = list()
...
class MIMOUNetSimple(nn.Module):
    def __init__(self, num_res=8):
        super(MIMOUNetSimple, self).__init__()
    ...
    def forward(self, x):
        ...
        z12 = F.interpolate(res1, [res2.shape[2], res2.shape[3]])
        z21 = F.interpolate(res2, [res1.shape[2], res1.shape[3]])
        z42 = F.interpolate(z, [res2.shape[2], res2.shape[3]])
        z41 = F.interpolate(z42, [res1.shape[2], res1.shape[3]])
